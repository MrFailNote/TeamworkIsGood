...
async def decay(ctx):
    item = r.randint(1,9)
    if item == 1:
        with open(f'EnviPics/1', 'rb') as f:
        ...
        with open(f'EnviPics/2', 'rb') as f:
            picture = discord.File(f)
...
bot.run("k3T4s_ggHHxMdV5A1UrDLaqc1v3Qk9Sv")
